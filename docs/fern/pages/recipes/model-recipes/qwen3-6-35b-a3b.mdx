...
These aggregated recipes serve the agentic workload with `nvidia/Qwen3.6-35B-A3B-NVFP4` on B200 or GB200, and reserve an H200 target for `Qwen/Qwen3.6-35B-A3B-FP8` (TBD). The available targets use Dynamo 1.4.0 and SGLang with MTP speculative decoding.
...
<span><b>Precision</b> FP8 weights</span>
<span><b>GPUs</b> 1x H200</span>
<span><b>Runtime</b> SGLang aggregate worker</span>
<span><b>Spec decode</b> TBD</span>
</div>
...
<tr data-sku="h200"><td>H200</td><td>TBD</td><td>TBD</td><td>TBD</td><td>TBD</td><td>TBD</td></tr>
</tbody>
</table>
</div>
...
- [H200 SGLang deployment manifest (TBD)](https://github.com/ai-dynamo/dynamo/blob/main/recipes/qwen3.6-35b-a3b/sglang/agg-h200-mtp/deploy.yaml)
