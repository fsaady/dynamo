...
When benchmarking vLLM with synthetic acceptance, set `rejection_sample_method`
to `synthetic` and `synthetic_acceptance_length` to `3.3153` in
`--speculative-config`.
...
<tr data-gpu="h200"><td><code>vllm/agg-h200-mtp/deploy.yaml</code></td><td>FP8</td><td>H200</td><td>3,411</td><td>130</td><td>1,871.80</td><td>75.48</td><td>71.60</td><td>444.51 ms</td></tr>
</tbody>
</table>
</div>
