...
DFlash has the highest tok/s/user among the H100 disaggregated rows in the source inventory; DSpark has the highest output tok/s/GPU. Use `disagg-h100-mtp` or `disagg-h100-dspark` to compare the other speculative decoding modes.
